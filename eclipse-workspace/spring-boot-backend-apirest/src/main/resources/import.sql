...
INSERT INTO usuarios (username, dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES('luli', true, 'luli.png', 'Lucía', 'Riobó Pérez', '77885544D', 'luciarioboperez99@gmail.com', 'Calle Granada, 234, La Victoria, Málaga', '$2a$10$DOMDxjYyfZ/e7RcBfUpzqeaCs8pLgcizuiQWXPkU35nOhZlFcE9MS', 'cliente', '1999-11-09', '369852147');
...
INSERT INTO notificaciones (usuario_id, descripcion, tipo, fecha, hora_generacion) VALUES (13, 'A partir del próximo lunes, los horarios de apertura del gimnasio se adelantarán una hora. El nuevo horario será de 7:00 a 22:00.', 'Aviso', '2024-07-09', '11:00');
INSERT INTO notificaciones (usuario_id, descripcion, tipo, fecha, hora_generacion) VALUES (14, '¡No te pierdas nuestra promoción especial de verano! Obtén un descuento del 20% en todas las membresías nuevas durante todo el mes de julio.', 'Anuncio', '2024-07-08', '09:30');
INSERT INTO notificaciones (usuario_id, descripcion, tipo, fecha, hora_generacion) VALUES (13, 'Por motivos de mantenimiento, el gimnasio permanecerá cerrado el próximo sábado 13 de julio. Reanudaremos nuestras actividades el domingo 14 de julio. Disculpa las molestias.', 'Aviso', '2024-07-05', '13:20');
INSERT INTO notificaciones (usuario_id, descripcion, tipo, fecha, hora_generacion) VALUES (14, 'Estamos emocionados de presentarte nuestro nuevo programa de entrenamiento de fuerza y ​​acondicionamiento físico. ¡Sigue con nosotros para alcanzar tus objetivos de fitness!', 'Anuncio', '2024-07-07', '08:00');
