...
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(false, 'cubo.png', 'Juan', 'Cubo Bravo', '99999999J', 'cubojuan@gmail.com', 'Calle Carretería, 789, La Merced, Málaga', 'laliLe12', 'cliente', '2001-07-22', '654123987');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(true, 'silvia.png', 'Silvia', 'Carrasco Miedes', '12345678D', 'silviaacm3@gmail.com', 'Calle Marqués de Larios, 321, El Molinillo, Málaga', 'Sisinono45', 'cliente', '2001-07-09', '741852963');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(true, 'vicente.png', 'Vicente', 'Navarro Jurado', '78956412D', 'vnavarro@gmail.com', 'Calle San Agustín, 890, La Trinidad, Málaga', 'Vengala23', 'cliente', '1967-11-02', '159263478');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(true, 'luli.png', 'Lucia', 'Riobo Perez', '77885544D', 'luli@gmail.com', 'Calle Granada, 234, La Victoria, Málaga', '32Rueda', 'cliente', '1999-11-09', '369852147');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(false, 'tamayo.png', 'Pablo', 'Tamayo Medina', '96857412D', 'tamamedi@gmail.com', 'Paseo del Parque, 567, Centro, Málaga', 'Patito543', 'cliente', '2001-02-07', '852741963');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(true, 'maria.png', 'Maria de la O', 'Bujalance Castilla', '88965412J', 'mdelao@gmail.com', 'Calle Alcazabilla, 222, Centro Histórico, Málaga', 'ruEDas56', 'cliente', '1967-04-25', '456123789');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(true, 'adolfo.png', 'Adolfo', 'Gonzalez Bujalance', '78962222D', 'adolgon@gmail.com', 'Calle Alameda Principal, 333, Centro, Málaga', 'Lejia2365', 'cliente', '2004-04-04', '987456321');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(true, 'enrique.png', 'Enrique', 'Navarro Jurado', '78754412E', 'enavarro@gmail.com', 'Plaza de la Constitución, 111, Centro Histórico, Málaga', 'mAqUiNa99', 'cliente', '1966-05-24', '123987654');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(false, 'natalia.png', 'Natalia', 'Paez Marquez', '78965431K', 'nati@gmail.com', 'Calle Compañía, 444, Centro Histórico, Málaga', 'papelerIa954', 'cliente', '2001-08-29', '321987654');
INSERT INTO usuarios (dado_de_alta, foto, nombre, apellidos, dni, email, domicilio, password, rol, fecha_nacimiento, telefono) VALUES(true, 'dani.png', 'Daniel', 'Gonzalez Holgado', '78963311L', 'dgon@gmail.com', 'Paseo Marítimo Antonio Banderas, 555, Huelin, Málaga', 'Jueves6587', 'cliente', '2001-12-15', '987654321');
INSERT INTO usuarios (username, dado_de_alta, nombre, apellidos, dni, email, domicilio, password, fecha_nacimiento, telefono) VALUES('admin', true, 'Admin', 'Admininstrador', '77963311L', 'admin@gmail.com', 'Calle Banderas, 555, Huelin, Málaga', '$2a$10$DOMDxjYyfZ/e7RcBfUpzqeaCs8pLgcizuiQWXPkU35nOhZlFcE9MS', '2001-12-15', '987654321');
